...
import { FiExternalLink, FiTerminal, FiCalendar } from "react-icons/fi";
...
const BlogPost = ({ post }) => {
    ...
    return (
        <motion.div
            ...
            whileHover={{ 
                scale: 1.02, 
                borderColor: "#39ff14", // Accent the border on hover
        ...
        >
            ...
            <div className="p-6 md:p-8 flex flex-col h-full">
                ...
                {/* Read More Button (Styled as a command link) */}
                <button
